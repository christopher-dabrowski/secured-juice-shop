...
export const PasswordStrengthInstruction: ChallengeInstruction = {
  ...
  hints: [
    ...
    },
    {
      ...
      fixture: "#password",
      unskippable: true,
      resolved: waitForInputToHaveValue(
        "#password",
        "F7eqgNr8R2tx5Jf@q7xT^E5!h@g%Sy"
      ),
    },
    {
    ...
    {
      text: "🎉 Congratulations! You have been logged in as the **administrator** of the shop thanks to his very ill chosen password!",
      fixture: "app-navbar",
