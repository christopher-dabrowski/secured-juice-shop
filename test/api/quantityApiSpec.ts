...
describe("/api/Quantitys/:ids", () => {
  ...
  xit("GET quantity of all items for accounting users from IP 123.456.789", () => {
    // TODO Check if possible to set IP in frisby tests
    return frisby
      .post(`${REST_URL}/user/login`, {
        headers: jsonHeader,
        body: {
